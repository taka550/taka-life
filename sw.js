const CACHE='taka-life-v2.0.0';
const ASSETS=['./','./index.html','./styles.css?v=2.0.0','./app.js?v=2.0.0','./manifest.webmanifest?v=2.0.0','./icon.svg','./icon-192-v2.png','./icon-512-v2.png','./apple-touch-icon-v2.png'];
